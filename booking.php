            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="27-3">March 27,2024</option>
                        <option value="28-3">March 28,2024</option>
                        <option value="29-3">March 29,2024</option>
                        <option value="30-3">March 30,2024</option>
                        <option value="31-3">March 31,2024</option>
                    </select>
